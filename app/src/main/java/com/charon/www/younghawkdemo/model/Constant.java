...
public class Constant {
    ...
    public static final String PLAN_PLAN = "PLAN_PLAN";
    public static final String DISCUSS_TITLE = "DISCUSS_TITLE";
    public static final String DISCUSS_CONTENT = "DISCUSS_CONTENT";

    public static final int TYPE_ITEM_HOME = 0x00;
    public static final int TYPE_ITEM_PLAN = 0x01;
    public static final int TYPE_ITEM_DISCUSS = 0x02;
    public static final int TYPE_FOOTER = 0x03;
    public static final int TYPE_END = 0x04;
    public static final int TYPE_ERROR = 0x05;
    public static final int TYPE_TITLE = 0x06;
