...
public class Date {
    ...
    private Man man00 = new Man("张挺","运营专责","13896131363","957291234","zhang.ting@nexuslink.cn");
    private Man man01 = new Man("陈思捷","运营专责","15922861093","707370312","chen.sijie@nexuslink.cn");
    private Man man02 = new Man("杨键","运营专责","18883992485","1179903196","yang.jian@nexuslink.cn");
    private Man man03 = new Man("张文梁","运营专责","17784325978","1024762489","zhang.wenliang@nexuslink.cn");

    private Man man10 = new Man("瞿强","中学指导","15922679569","366237235","366237235@qq.com");
    private Man man11 = new Man("李艺","中学指导","13983905927","83241034","83241034@qq.com");
    private Man man12 = new Man("李才猛","中学指导","13883140809","316331557","316331557@qq.com");
    private Man man13 = new Man("马宪羽","中学指导","13452905409","274030922","274030922@qq.com");

    private Man man20 = new Man("匡政泽","牵头人","13101280185","1284629130","kuang.zhengze@nexuslink.cn");
    private Man man21 = new Man("周家豪","项目指导","15340504859","1078463794","zhou.jiahao@nexuslink.cn");
    private Man man22 = new Man("张兴锐","项目指导","15086943358","2855892305","zhang.xingrui@nexuslink.cn");
    private Man man23 = new Man("黄嘉豪","雏鹰学员","15922838340","1509173305","huang.jiahao666@foxmail.com");
    private Man man24 = new Man("李云飞","雏鹰学员","15922542978","1275995471","li.yunfei88@foxmail.com");
    private Man man25 = new Man("施伟成","雏鹰学员","13983282082","1092089364","shi.weicheng@foxmail.com");
